...
//     on<FetchOrderByUserIdEvent>(_fetchOrdersByUserId);
//   }

//   Future<FutureOr<void>> _addOrder(
...
//           final updatedOrders = List<Order>.from(state.result ?? []);
//           updatedOrders.add(event.payload);

//           final updatedState = state.copyWith(
//               result: updatedOrders, orderStatus: OrderStatus.success);
//           emit(updatedState);
//         }
//       } else {
...
//   Future<FutureOr<void>> _fetchOrders(
...
//   Future<FutureOr<void>> _fetchOrdersByUserId(
//       FetchOrderByUserIdEvent event, Emitter<OrderState> emit) async {
//     try {
//       final NetworkConnect newNetworkConnect = NetworkConnect();
//       final Dio dio = DioConfig.dioWithAuth;
